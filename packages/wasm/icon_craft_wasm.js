/* @ts-self-types="./icon_craft_wasm.d.ts" */
 ...
 * @returns {any}
 */
export function generate_clippath(svg_content, mode, offset, resolution, simplify_epsilon) {
 ...
 * @returns {any}
 */
export function generate_clippath_with_icon(svg_content, mode, offset, resolution, simplify_epsilon, include_icon) {
    const ptr0 = passStringToWasm0(svg_content, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
